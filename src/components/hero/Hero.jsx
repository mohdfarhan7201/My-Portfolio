...
function Hero() {
    ...
    return (
        <section
            ref={heroRef}
            id="home"
            className="relative h-screen w-full overflow-hidden bg-black flex items-center px-10 md:px-32"
        >
            ...
            >
                <div className="overflow-hidden">
                    <p className="tracking-[12px] text-zinc-500 uppercase text-xs md:text-sm mb-6 animate-pulse">
                        Digital Experiences Architect
                    </p>

                </div>

                <h1 className="text-gradient text-[80px] font-black tracking-tighter leading-[0.85] md:text-[40px] lg:text-[80px]">
                    MOHD FARHAN
                </h1>
                ...
                <div className="mt-14 flex items-center gap-10">
                    <a
                        href="#projects"
                        className="group relative px-12 py-5 overflow-hidden rounded-full border border-white/20 text-[10px] font-bold uppercase tracking-[4px] transition-all hover:border-white"
                    >
            ...
            {/* Side Label */}
            <div className="absolute right-10 bottom-32 hidden lg:block rotate-90 origin-right translate-x-1/2 opacity-20 hover:opacity-100 transition-opacity">
                <span className="text-[10px] tracking-[15px] uppercase">Portfolio 2026</span>
            </div>

            {/* Scroll Indicator */}
            <div className="absolute bottom-12 left-10 md:left-32 flex flex-col items-start gap-4 opacity-20">
                <span className="text-[9px] tracking-[4px] uppercase [writing-mode:vertical-lr]">Scroll Down</span>
